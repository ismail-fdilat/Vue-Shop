<template>
  <div class="Admin">
    <div
      v-show="nottoggled"
      @click="showbar"
      class="d-flex align-items-center justify-content-center toggle-icon"
    >
      ...
      <nav id="sidebar" class="sidebar-wrapper">
        <div class="sidebar-content">
          ...
          <div class="sidebar-item sidebar-brand">
            ...
            <span id="close-sidebar" @click="closebar">
